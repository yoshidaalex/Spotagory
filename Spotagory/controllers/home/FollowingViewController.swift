...
class FollowingViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let user = item.objectForKey("user") as! [String : AnyObject]
        ...
        let avatar_link = user["avatar"] as? String
        ...
        cell.lblLocation.text = String(format: "%@, %@", (user["city"] as? String)!, (user["country"] as? String)!)
        
        cell.btnFollow.addTarget(self, action: #selector(FollowingViewController.setUnFollow(_:)), forControlEvents: .TouchUpInside)
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        viewCon.userData = item.objectForKey("user") as? NSDictionary
    ...
    func loadFollowing() {
        ...
        let api_link = String(format: "/users/%@/following?page=%d", SpotagoryKeeper.keeper.getUserId()!, self.page_number)
    ...
    func setUnFollow(sender : UIButton) {
