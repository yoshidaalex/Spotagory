...
- (UIView *)topView {
    if (_topView == nil) {
        ...
        rect = CGRectMake(0, 20, 60, CGRectGetHeight(navView.bounds) - 20);
        ...
        rect = CGRectMake((CGRectGetWidth(navView.bounds)-100)/2, 20, 100, CGRectGetHeight(navView.bounds) - 20);
        ...
        rect = CGRectMake(CGRectGetWidth(navView.bounds)-80, 20, 80, CGRectGetHeight(navView.bounds) - 20);
        ...
        rect = CGRectMake(0, CGRectGetHeight(self.topView.bounds)-(handleHeight + 20), CGRectGetWidth(self.topView.bounds), handleHeight + 20);
        ...
        rect = CGRectMake(0, handleHeight + 20, CGRectGetWidth(self.topView.bounds), CGRectGetHeight(self.topView.bounds)-(handleHeight + 20)*2);
